...
export default function LiquidityPage() {
  ...
  return (
    <div className="flex flex-col items-stretch max-w-4xl gap-8 m-auto">
      ...
      {/* TODO: stop the user setting the token amount when there’s an exchange ratio, 
      and setting it for them based on the STX provided. 
      Since they have to match the ratio, we could just do it for them. */}
